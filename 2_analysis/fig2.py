...
ds2 = xr.open_dataset("2_analysis/fig2_relay46810/Mestimated6_2x2_sign_correct_wrong.nc")
...
ds2 = xr.open_dataset("2_analysis/fig2_relay46810/Mestimated4_2x2_sign_correct_wrong.nc")
...
def create_map(ax):
  ...
  ax.tick_params(axis='y', right=False, length=7.0, width=1.0, labelsize=10.5, color='black')
  ax.tick_params(axis='x', right=False, length=7.0, width=1.0, labelsize=12.0, color='black')
...
ax3.text(4.35, relay_correct6[0,6]-0.60, s='100%', fontsize=11.0, color='#E5637B')
ax3.text(-0.5, 1.45, s='b', fontsize=15.0, color='black', fontweight='bold')
ax3.text(31.5, 0.95, s='('+r"$A_6$"+")"r"$^1$", fontsize=12.5, color='black')
...
ax4.text(9.8, relay_correct6[1,12]-0.24, s='99.2%', fontsize=11.0, color='#D2AA3A')
ax4.text(31.5, 0.95, s='('+r"$A_6$"+")"r"$^2$", fontsize=12.5, color='black')
...
ax5.text(15.8, relay_correct6[2,18]-0.24, s='97.9%', fontsize=11.0, color='#009E74')
ax5.text(31.5, 0.95, s='('+r"$A_6$"+")"r"$^3$", fontsize=12.5, color='black')
...
ax6.text(21.8, relay_correct6[3,24]-0.24, s='90.9%', fontsize=11.0, color='#57B4E9')
ax6.text(31.5, 0.95, s='('+r"$A_6$"+")"r"$^4$", fontsize=12.5, color='black')
...
ax7.text(27.8, relay_correct6[4,30]-0.24, s='80.2%', fontsize=11.0, color='#333A8C')
ax7.text(31.5, 0.95, s='('+r"$A_6$"+")"r"$^5$", fontsize=12.5, color='black')
...
ax13.text(2.35, relay_correct4[0,4]-0.60, s='100%', fontsize=11.0, color='#E5637B')
ax13.text(-0.5, 1.45, s='a', fontsize=15.0, color='black', fontweight='bold')
ax13.text(31.5, 0.95, s='('+r"$A_4$"+")"r"$^1$", fontsize=12.5, color='black')
ax13.text(4.3, 1.85, s="Similarity   between   short-delayed   and   long-delayed   networks", fontsize=14.5, color='black')
...
ax14.text(5.8, relay_correct4[1,8]-0.24, s='96.2%', fontsize=11.0, color='#D2AA3A')
ax14.text(31.5, 0.95, s='('+r"$A_4$"+")"r"$^2$", fontsize=12.5, color='black')
...
ax15.text(9.8, relay_correct4[2,12]-0.24, s='94.0%', fontsize=11.0, color='#009E74')
ax15.text(31.5, 0.95, s='('+r"$A_4$"+")"r"$^3$", fontsize=12.5, color='black')
...
ax16.text(13.8, relay_correct4[3,16]-0.24, s='87.2%', fontsize=11.0, color='#57B4E9')
ax16.text(31.5, 0.95, s='('+r"$A_4$"+")"r"$^4$", fontsize=12.5, color='black')
...
ax17.text(17.6, relay_correct4[4,20]-0.24, s='80.1%', fontsize=11.0, color='#333A8C')
ax17.text(31.5, 0.95, s='('+r"$A_4$"+")"r"$^5$", fontsize=12.5, color='black')
...
fig.savefig('2_analysis/Figure2.png', bbox_inches = 'tight')
plt.show()
