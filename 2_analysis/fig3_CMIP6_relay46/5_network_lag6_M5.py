...
network_34models_M5 = np.zeros([34, 60,180, 60,180], dtype=np.float32)
...
for imodel in range(34):
      ...
      network_34models_M5[imodel,:,:,:,:] = M5_4D.copy()




##--##--##--##--    to nc file    --##--##--##--##
M5_array0= xr.DataArray(data=network_34models_M5, dims=['model', 'lat1', 'lon1', 'lat2', 'lon2'],
...
ds0 = xr.Dataset(data_vars=dict(M5=M5_array0))
ds0.to_netcdf("2_analysis/fig3_CMIP6_relay46/Network_2x2_historical_lag6_M5.nc")
ds0.close()
